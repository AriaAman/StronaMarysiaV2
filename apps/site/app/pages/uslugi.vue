<template>
  <div class="services-page">
    <!-- HERO -->
    <ServicesHero :active="activeCat" @select="scrollToCategory" />

    <!-- GRID DES SERVICES -->
    <section class="services-section">
      <div class="services-container">
        <ServiceCard v-for="(srv, idx) in services" :key="srv.title" :service="srv" :index="idx"
...
const fallbackServices = [
  {
    ...
    caption: 'Implanty',
    image: '/static/uslugi/implanty.avif',
    category: 'implanty',
    description: `
  ...
  },
  {
    ...
    caption: 'Endodoncja',
    image: '/static/uslugi/endodoncja.avif',
    category: 'endodoncja',
    description: `
    <p style="color: #A9722D;">
  ...
  },
  {
    title: 'Protetyka',
    caption: 'Protetyka',
    image: '/static/uslugi/protetyka.avif',
    category: 'protetyka',
    description: `
    <p style="color: #A9722D;">
  ...
  },
  {
    ...
    caption: 'Stomatologia estetyczna',
    image: '/static/uslugi/stomatologia-estetyczna.avif',
    category: 'estetyczna',
    description: `
    <p style="color: #A9722D;">
  ...
  },
  {
    ...
    caption: 'Stomatologia zachowawcza',
    image: '/static/uslugi/stomatologia-zachowawcza.avif',
  ...
  },
  {
    title: 'Diagnostyka',
    caption: 'Diagnostyka',
    image: '/static/uslugi/diagnostyka.avif',
  ...
  {
    title: 'Profilaktyka',
    caption: 'Profilaktyka',
    image: '/static/uslugi/profilaktyka.avif',
  ...
  },
  {
    ...
    caption: 'Chirurgia stomatologiczna',
    image: '/static/uslugi/chirurgia-stomatologiczna.avif',
    category: 'chirurgia',
    description: `
    <p style="color: #A9722D;">
    To zaawansowana dziedzina stomatologii, zajmująca się odbudową braków w uzębieniu poprzez
...
const serviceImagesByCategory = Object.fromEntries(
  fallbackServices.map((service) => [service.category, service.image])
)

const supabase = useSupabase()

const { data } = useAsyncData('site-services', async () => {
  const { data: rows, error } = await supabase
    .from('site_services')
    .select('id,title,caption,category,description,sort_order,is_active')
    .eq('is_active', true)
  ...
  return rows.map((row) => ({
    ...row,
    image: serviceImagesByCategory[row.category] || ''
  }))
}, {
...
const services = computed(() => data.value || fallbackServices)
</script>
